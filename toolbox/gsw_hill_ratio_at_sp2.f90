...
real (r14), parameter :: sp2 = 2d0

real (r14) :: t68, ft68, rtx0, dsp_drtx, sp_est, rtx, rtxm, x, part1, part2
real (r14) :: sqrty, sp_hill_raw_at_sp2
...
dsp_drtx =  a1 + (2d0*a2 + (3d0*a3 + (4d0*a4 + 5d0*a5*rtx0)*rtx0)*rtx0)*rtx0 + &
      ft68*(b1 + (2d0*b2 + (3d0*b3 + (4d0*b4 + 5d0*b5*rtx0)*rtx0)*rtx0)*rtx0) 
...
gsw_hill_ratio_at_sp2 = 2d0/sp_hill_raw_at_sp2
