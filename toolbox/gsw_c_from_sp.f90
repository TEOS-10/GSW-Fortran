...
real (r8), parameter :: q15 = 1.120748754429459e-4
...
!                 value of Rtx at which the derivative dSP_dRtx is evaluated.
    ...
    dsp_drtx = a1 + (2.0_r8*a2 + (3.0_r8*a3 + (4.0_r8*a4 + 5.0_r8*a5*rtxm)*rtxm)*rtxm)*rtxm&
       + ft68*(b1 + (2.0_r8*b2 + (3.0_r8*b3 + (4.0_r8*b4 + 5.0_r8*b5*rtxm)*rtxm)*rtxm)*rtxm)
    if (sp_est .lt. 2.0_r8) then
